...
import pytest
from test_api.clients.api_httpx_integration import async_response_post, async_response_delete

# 匯入斷言模組，檢查回傳資料正確性與錯誤碼
from test_api.test.integration.helpers.test_user_post_error_assertions import (
...
async def test_422_user_id(user_from, error_msg):
    response = await async_response_post(user_from)
